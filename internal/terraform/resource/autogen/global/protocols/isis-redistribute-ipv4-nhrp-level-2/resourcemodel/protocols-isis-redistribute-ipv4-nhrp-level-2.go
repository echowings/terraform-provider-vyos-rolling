...
var _ helpers.VyosTopResourceDataModel = &ProtocolsIsisRedistributeIPvfourNhrpLevelTwo{}

// ProtocolsIsisRedistributeIPvfourNhrpLevelTwo describes the resource data model.
// This is a basenode!
...
type ProtocolsIsisRedistributeIPvfourNhrpLevelTwo struct {
	...
	// LeafNodes
	LeafProtocolsIsisRedistributeIPvfourNhrpLevelTwoMetric   types.Number `tfsdk:"metric" vyos:"metric,omitempty"`
	LeafProtocolsIsisRedistributeIPvfourNhrpLevelTwoRouteMap types.String `tfsdk:"route_map" vyos:"route-map,omitempty"`
...
func (o *ProtocolsIsisRedistributeIPvfourNhrpLevelTwo) SetID(id []string) {
	o.ID = basetypes.NewStringValue(strings.Join(id, "__"))
}

// GetTimeouts returns resource timeout config
func (o *ProtocolsIsisRedistributeIPvfourNhrpLevelTwo) GetTimeouts() timeouts.Value {
	return o.Timeouts
}

// IsGlobalResource returns true if this is global
// This is useful during CRUD delete
func (o *ProtocolsIsisRedistributeIPvfourNhrpLevelTwo) IsGlobalResource() bool {
	return (true)
}

// GetVyosPath returns the list of strings to use to get to the correct vyos configuration
func (o *ProtocolsIsisRedistributeIPvfourNhrpLevelTwo) GetVyosPath() []string {
	return append(
		o.GetVyosParentPath(),
		"level-2",
	)
...
func (o *ProtocolsIsisRedistributeIPvfourNhrpLevelTwo) GetVyosParentPath() []string {
	return []string{
...
func (o *ProtocolsIsisRedistributeIPvfourNhrpLevelTwo) GetVyosNamedParentPath() []string {
	return []string{
...
func (o ProtocolsIsisRedistributeIPvfourNhrpLevelTwo) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
