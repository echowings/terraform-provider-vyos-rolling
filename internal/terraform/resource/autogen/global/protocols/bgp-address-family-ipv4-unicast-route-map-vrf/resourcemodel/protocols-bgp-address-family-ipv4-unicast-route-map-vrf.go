...
var _ helpers.VyosTopResourceDataModel = &ProtocolsBgpAddressFamilyIPvfourUnicastRouteMapVrf{}

// ProtocolsBgpAddressFamilyIPvfourUnicastRouteMapVrf describes the resource data model.
// This is a basenode!
...
type ProtocolsBgpAddressFamilyIPvfourUnicastRouteMapVrf struct {
	...
	// LeafNodes
	LeafProtocolsBgpAddressFamilyIPvfourUnicastRouteMapVrfImport types.String `tfsdk:"import" vyos:"import,omitempty"`
...
func (o *ProtocolsBgpAddressFamilyIPvfourUnicastRouteMapVrf) SetID(id []string) {
	o.ID = basetypes.NewStringValue(strings.Join(id, "__"))
}

// GetTimeouts returns resource timeout config
func (o *ProtocolsBgpAddressFamilyIPvfourUnicastRouteMapVrf) GetTimeouts() timeouts.Value {
	return o.Timeouts
}

// IsGlobalResource returns true if this is global
// This is useful during CRUD delete
func (o *ProtocolsBgpAddressFamilyIPvfourUnicastRouteMapVrf) IsGlobalResource() bool {
	return (true)
}

// GetVyosPath returns the list of strings to use to get to the correct vyos configuration
func (o *ProtocolsBgpAddressFamilyIPvfourUnicastRouteMapVrf) GetVyosPath() []string {
	return append(
		o.GetVyosParentPath(),
		"vrf",
	)
...
func (o *ProtocolsBgpAddressFamilyIPvfourUnicastRouteMapVrf) GetVyosParentPath() []string {
	return []string{
...
func (o *ProtocolsBgpAddressFamilyIPvfourUnicastRouteMapVrf) GetVyosNamedParentPath() []string {
	return []string{
...
func (o ProtocolsBgpAddressFamilyIPvfourUnicastRouteMapVrf) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
