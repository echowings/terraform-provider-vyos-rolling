...
var _ helpers.VyosTopResourceDataModel = &ProtocolsIsisRedistributeIPvfourNhrpLevelOne{}

// ProtocolsIsisRedistributeIPvfourNhrpLevelOne describes the resource data model.
// This is a basenode!
...
type ProtocolsIsisRedistributeIPvfourNhrpLevelOne struct {
	...
	// LeafNodes
	LeafProtocolsIsisRedistributeIPvfourNhrpLevelOneMetric   types.Number `tfsdk:"metric" vyos:"metric,omitempty"`
	LeafProtocolsIsisRedistributeIPvfourNhrpLevelOneRouteMap types.String `tfsdk:"route_map" vyos:"route-map,omitempty"`
...
func (o *ProtocolsIsisRedistributeIPvfourNhrpLevelOne) SetID(id []string) {
	o.ID = basetypes.NewStringValue(strings.Join(id, "__"))
}

// GetTimeouts returns resource timeout config
func (o *ProtocolsIsisRedistributeIPvfourNhrpLevelOne) GetTimeouts() timeouts.Value {
	return o.Timeouts
}

// IsGlobalResource returns true if this is global
// This is useful during CRUD delete
func (o *ProtocolsIsisRedistributeIPvfourNhrpLevelOne) IsGlobalResource() bool {
	return (true)
}

// GetVyosPath returns the list of strings to use to get to the correct vyos configuration
func (o *ProtocolsIsisRedistributeIPvfourNhrpLevelOne) GetVyosPath() []string {
	return append(
		o.GetVyosParentPath(),
		"level-1",
	)
...
func (o *ProtocolsIsisRedistributeIPvfourNhrpLevelOne) GetVyosParentPath() []string {
	return []string{
...
func (o *ProtocolsIsisRedistributeIPvfourNhrpLevelOne) GetVyosNamedParentPath() []string {
	return []string{
...
func (o ProtocolsIsisRedistributeIPvfourNhrpLevelOne) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
