...
var _ helpers.VyosTopResourceDataModel = &ProtocolsOspfRedistributeNhrp{}

// ProtocolsOspfRedistributeNhrp describes the resource data model.
// This is a basenode!
// Top level basenode type: `Node`
type ProtocolsOspfRedistributeNhrp struct {
	ID       types.String   `tfsdk:"id" vyos:"-,tfsdk-id"`
	Timeouts timeouts.Value `tfsdk:"timeouts" vyos:"-,timeout"`

	// LeafNodes
	LeafProtocolsOspfRedistributeNhrpMetric     types.Number `tfsdk:"metric" vyos:"metric,omitempty"`
	LeafProtocolsOspfRedistributeNhrpMetricType types.Number `tfsdk:"metric_type" vyos:"metric-type,omitempty"`
	LeafProtocolsOspfRedistributeNhrpRouteMap   types.String `tfsdk:"route_map" vyos:"route-map,omitempty"`
...
func (o *ProtocolsOspfRedistributeNhrp) SetID(id []string) {
	o.ID = basetypes.NewStringValue(strings.Join(id, "__"))
}

// GetTimeouts returns resource timeout config
func (o *ProtocolsOspfRedistributeNhrp) GetTimeouts() timeouts.Value {
	return o.Timeouts
}

// IsGlobalResource returns true if this is global
// This is useful during CRUD delete
func (o *ProtocolsOspfRedistributeNhrp) IsGlobalResource() bool {
	return (true)
}

// GetVyosPath returns the list of strings to use to get to the correct vyos configuration
func (o *ProtocolsOspfRedistributeNhrp) GetVyosPath() []string {
	return append(
		o.GetVyosParentPath(),
		"nhrp",
	)
...
func (o *ProtocolsOspfRedistributeNhrp) GetVyosParentPath() []string {
	return []string{
...
func (o *ProtocolsOspfRedistributeNhrp) GetVyosNamedParentPath() []string {
	return []string{
...
func (o ProtocolsOspfRedistributeNhrp) ResourceSchemaAttributes(ctx context.Context) map[string]schema.Attribute {
