---
page_title: "vyos_vrf_name_protocols_rpki_cache Resource - vyos"

subcategory: "Vrf"

description: |-
  Virtual Routing and Forwarding⯯Virtual Routing and Forwarding instance⯯Routing protocol parameters⯯Resource Public Key Infrastructure (RPKI)⯯RPKI cache server address
---

# vyos_vrf_name_protocols_rpki_cache (Resource)
<center>
...
- [vyos_vrf_name_protocols_rpki_cache (Resource)](#vyos_vrf_name_protocols_rpki_cache-resource)
  - [Schema](#schema)
    - [Required](#required)
...
```shell
terraform import vyos_vrf_name_protocols_rpki_cache.example "vrf__name__<name>__protocols__rpki__cache__<cache>"
```
